...
mapping: dict[str, TuyaBLECategorySwitchMapping] = {
    ...
    "kg": TuyaBLECategorySwitchMapping(
        products={
            "riecov42": [  # Fingerbot - OPRAVENÉ dp_id
                TuyaBLEFingerbotSwitchMapping(dp_id=1),  # OPRAVENO: 2 → 1
                TuyaBLEReversePositionsMapping(dp_id=104),  # OPRAVENO: 11 → 104
                TuyaBLESwitchMapping(
                    dp_id=107,  # PŘIDÁNO: Touch Control
                    description=SwitchEntityDescription(
                        key="manual_control",
